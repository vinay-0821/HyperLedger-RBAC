...
export interface GrpcClient {
    ...
    makeUnaryRequest<RequestType, ResponseType>(method: string, serialize: (value: RequestType) => Buffer, deserialize: (value: Buffer) => ResponseType, argument: RequestType, metadata: CallOptions | Metadata, callback: requestCallback<ResponseType>): ClientUnaryCall;
    ...
    makeClientStreamRequest<RequestType, ResponseType>(method: string, serialize: (value: RequestType) => Buffer, deserialize: (value: Buffer) => ResponseType, metadata: CallOptions | Metadata, callback: requestCallback<ResponseType>): ClientWritableStream<RequestType>;
